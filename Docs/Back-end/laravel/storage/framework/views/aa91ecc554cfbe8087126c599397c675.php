...
<body>
    ...
    <script>
        ...
        $('#form-anuncio').on('submit', function(e) {
            ...
            $.ajax({
                url: '<?php echo e(url("/anuncie")); ?>', // Corrigido: envia para a rota correta
                type: 'POST',
                data: {
                    titulo: $('#titulo').val(),
...
<?php /**PATH C:\Users\eduar\OneDrive\Desktop\TopCar-Web-Trabalho-main\Docs\Back-end\laravel\resources\views/anuncie.blade.php ENDPATH**/ ?>